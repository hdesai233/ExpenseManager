...
const TAXONOMY: SeedCat[] = [
  ...
  { id: 'income', name: 'Income', color: '#5a7f9c', subs: [['paycheck', 'Paycheck'], ['interest', 'Interest'], ['other-income', 'Other Income']] },
...
const SEED_RULES: Array<[string, 'exact' | 'contains' | 'regex', string, string | null]> = [
  ...
  ['PAYROLL', 'contains', 'income', 'paycheck'],
  ['DIR DEP', 'contains', 'income', 'paycheck'],
  ['DIRECT DEP', 'contains', 'income', 'paycheck'],
  ['INTEREST PAYMENT', 'contains', 'income', 'interest'],
  ['INTEREST PAID', 'contains', 'income', 'interest'],
